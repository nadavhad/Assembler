assembler.out: out/errorlog.o out/assembler.o out/dissector.o
	mkdir -p out
	gcc -g  -Wall -ansi -pedantic out/errorlog.o out/assembler.o out/dissector.o -o out/assembler.out
...
out/dissector.o: assembler/dissector.c
	mkdir -p ./out/
	gcc -c assembler/dissector.c -o out/dissector.o -Wall -ansi -pedantic
